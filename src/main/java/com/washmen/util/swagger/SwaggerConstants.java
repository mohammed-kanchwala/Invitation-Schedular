package com.washmen.util.swagger;
...
public class SwaggerConstants {
    ...
    public static final String SWAGGER_PACKAGE = "com.washmen";
    public static final String SWAGGER_API_TITLE = "Partner Invitation Scheduler APIs";
